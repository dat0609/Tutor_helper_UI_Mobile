...
class TutorViewStudentInfo extends StatefulWidget {
  const TutorViewStudentInfo({Key? key}) : super(key: key);

  @override
  _TutorViewStudentInfoState createState() => _TutorViewStudentInfoState();
}

class _TutorViewStudentInfoState extends State<TutorViewStudentInfo> {
                ...
                if (studentData.hasData) {
                  ...
                  return Column(
                    children: [
                      ...
                      listItem("Phone", stuData.phoneNumber),
                    ],
                  );
                } else {
